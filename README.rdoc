...
For more features like black- and whitelisting, redirection, XSS and SQL injection detection,
please check out our rails web application firewall coming with a ready-to-use web front-end: https://github.com/symontech/detrusion
...
(c) 2011 netsense managed security audits - http://netsense.ch
